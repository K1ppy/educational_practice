...
console.log('remove');
console.log(adCollection.remove(33));
console.log(adCollection.remove(27));
console.log(adCollection.get(27));

console.log('edit');
console.log(adCollection.edit('1',{id:27}));
console.log(adCollection.edit('23',{description:'Some random description'}));
console.log(adCollection.edit('1',{description:'Some random description', link : 'random.org'}));
